/*Code Source Taken Here: https://stackoverflow.com/a/44871508/1862452*/
                    ...
                    while (_run)
                    {
                        try
                        {
                            ...
                            if(screenResource != null)
                            {
                                ...
                                // Get the desktop OldCapture texture
                                ...
                                using (var bitmap = new Bitmap(width, height, PixelFormat.Format32bppArgb))
                                {
                                    ...
                                    // Copy pixels from screen OldCapture Texture to GDI bitmap
